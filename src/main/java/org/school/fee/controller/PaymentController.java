...
public class PaymentController extends AbstractController {
	...
	public ModelAndView toPay(@PathVariable Integer page,Integer pageSize,
			@PathVariable ObjectId studentId,Boolean notClear,PayMethod payMethod,String feeName,	Date startDate,Date endDate,
		...
		Page<Payment> payments = paymentService.listPaymentFromStudent(page, pageSize,studentId,
				feeName,notClear,payMethod,startDate,endDate,orderBy,order); 
		logger.debug("total:{}",payments.getTotalElements());
		logger.debug("currentTotal:{}",payments.getNumberOfElements());
		Map<String,Object> filter = buildFilter(null,feeName,null,null,payMethod,startDate,endDate,notClear);
		Map<String,Object> result = buildResult(filter,payments);
	...
	public ModelAndView add(Payment payment,BigDecimal payMoney){
		...
		payment.setFeeStartDate(fee.getStartDate());
		payment.setFeeEndDate(fee.getEndDate());
	...
	public ModelAndView feeToPay(@PathVariable ObjectId feeId,@PathVariable Integer page,
			Integer pageSize,String studentName,String klass,String school,PayMethod payMethod,Boolean notClear,
		...
		Page<Payment> payments = paymentService.listPaymentFromFee(page, pageSize,feeId,studentName,
				klass,school,notClear,payMethod,startDate,endDate,orderBy,order);
		Map<String,Object> filter = buildFilter(studentName,null,klass,school,payMethod,startDate,endDate,notClear);
		Map<String,Object> result = buildResult(filter,payments);
		result.put("fee", fee);
		return new ModelAndView("/payment/index").addObject("result",result);
	}
	...
	public ModelAndView feeList(@PathVariable Integer page,Integer pageSize,
			String studentName,String feeName,String klass,String school,Boolean notClear,PayMethod payMethod,
			Date startDate,Date endDate,String orderBy,	String order){
		...
		Page<Payment> payments = paymentService.listPayment(page, pageSize,studentName,feeName,
				klass,school,notClear,payMethod,startDate,endDate,orderBy,order);
		Map<String,Object> filter = buildFilter(studentName,feeName,klass,school,payMethod,startDate,endDate,notClear);
		Map<String,Object> result = buildResult(filter,payments);
		return new ModelAndView("/payment/index").addObject("result",result);
	}
	...
	private Map<String,Object> buildFilter(String studentName,String feeName,String klass,String school,PayMethod payMethod,Date startDate,Date endDate,Boolean notClear){
	...
	private Map<String,Object> buildResult(Map<String,Object> filter,Page<Payment> payments){
