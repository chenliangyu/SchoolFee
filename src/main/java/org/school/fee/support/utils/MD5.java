...
public class MD5 {
	...
	/*
	 * digestHexStr MD5的唯\uFFFD \uFFFD个公共成员，是最新一次计算结果的 \uFFFD 16
	 * 制ASCII表示.
	 */
	...
	/*
	 * FF,GG,HH II将调用F,G,H,I进行近一步变\uFFFD FF, GG, HH, and II transformations
	...
	/*
	 * b2iu 我写的\uFFFD 把byte按照不\uFFFD
	 * 正负号的原则的＂升位＂程序，因为java没有unsigned运算
	 */
	...
	public static void main(String args[]) {
		...
		if (Array.getLength(args) == 0) { // 如果没有参数，执行标准的Test Suite
			...
			System.out.println("MD5(\"a\"):"
					+ m.getMD5ofStr("20001GOLDENWAY888").toLowerCase());
