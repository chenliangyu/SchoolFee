        ...
        <div class="container-fluid" id="main-container">
            ...
            <div id="main-content">
                ...
                <div class="page-title">
                    <div>
                        <h1><i class="icon-file-alt"></i>添加学生</h1>
                    ...
                    <div class="span12">
                        <div class="box">
                            ...
                            <div class="box-content">
                                <form action="${ctx}/action/student/postadd" method="post" class="form-horizontal form-row-separated">
                                    <div class="control-group">
                                        <label for="name" class="control-label">姓名</label>
                                        <div class="controls">
                                            <input type="text" name="name" id="name" placeholder="真实姓名" class="input-medium">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="age" class="control-label">年龄</label>
                                        <div class="controls">
                                            <input type="text" name="age" id="age" placeholder="年龄" class="input-mini">岁
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <label class="radio inline">
                                              <input type="radio" name="sex" value="0" checked/> 男孩
                                          </label>
                                          <label class="radio inline">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="klass" id="klass" placeholder="所属的你的学校的班级" class="input-large">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="school" id="school" placeholder="所属的你的学校将学生" class="input-large">
                                     ...
                                     <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="fatherName" id="fatherName" placeholder="学生父亲" class="input-large">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="motherName" class="control-label">母亲</label>
                                        <div class="controls">
                                            <input type="text" name="motherName" id="motherName" placeholder="学生母亲" class="input-large">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="phone" class="control-label">家长联系电话</label>
                                        <div class="controls">
                                            <input type="text" name="phone" id="phone" placeholder="多个以空格隔开,用于发送短信通知" class="input-xlarge">
